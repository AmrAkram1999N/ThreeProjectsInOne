<a class="btn btn-sm btn-outline-secondary  w-100" type="button" data-bs-toggle="modal" href="#exampleModalToggle"
    role="button">
    Add_New_Url
</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h5 class="modal-title text-white" id="exampleModalToggleLabel">Adding a new URL</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="card-body">
                    <form action="{{ route('Chain.Account.Auth.addShortLink') }}" method="POST">
                        @csrf
