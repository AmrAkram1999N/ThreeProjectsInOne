            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if (Route::currentRouteName() == 'Chain.' . $Model . '.Auth.User_Dash') active @endif" aria-current="page"
                                href="{{ route('Chain.' . $Model . '.Auth.User_Dash') }}">
                                <span data-feather="home"></span>
                                Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if (Route::currentRouteName() == 'Chain.' . $Model . '.Auth.User_Profile') active @endif"
                                href="{{ route('Chain.' . $Model . '.Auth.User_Profile') }}">
